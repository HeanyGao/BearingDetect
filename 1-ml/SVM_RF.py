...
if __name__ == '__main__':
    ...
    test_feature.to_csv("../result/Result by SVM.csv",index = 0,header=1,columns=['id','label'])
    ...
    test_feature_RF.to_csv("../result/Result by RF.csv",index = 0,header=1,columns=['id','label'])
    #print(RF_hat2)
